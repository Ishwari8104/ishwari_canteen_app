...
public class chinese_page{
    chinese_page(){
        JFrame f = new JFrame();
 
        // Frame Title
        f.setTitle("List of Chinese Items");
        ...
        try{
            ...
            PreparedStatement st = (PreparedStatement) connection.prepareStatement("select item_id, item_name, item_price from food where item_category = 'chinese';");
