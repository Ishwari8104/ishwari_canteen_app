...
public class south_indian_page{
    south_indian_page(){
        JFrame f = new JFrame();
 
        // Frame Title
        f.setTitle("List of South Indian Items");
        ...
        try{
            ...
            PreparedStatement st = (PreparedStatement) connection.prepareStatement("select item_id, item_name, item_price from food where item_category = 'south_indian';");
