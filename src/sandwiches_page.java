...
public class sandwiches_page{
    sandwiches_page(){
        ...
        try{
            ...
            PreparedStatement st = (PreparedStatement) connection.prepareStatement("select item_id, item_name, item_price from food where item_category = 'sandwiches';");
