...
public class lunch_page{
    lunch_page(){
        JFrame f = new JFrame();
 
        // Frame Title
        f.setTitle("List of Lunch Items");
        ...
        try{
            ...
            PreparedStatement st = (PreparedStatement) connection.prepareStatement("select item_id, item_name, item_price from food where item_category = 'lunch';");
